...
public class Triangle implements Shape {
    ...
    //this function make s(s-a)(s-b)(s-c).
    double calculateConstant() {
        double s = (getSide1() + getSide2() + getSide3())/2;
        return s * (s-getSide1()) * (s-getSide2()) * (s-getSide3());
    }

    Area triangle = () -> Math.sqrt(calculateConstant());
    ...
    public String toString() {
        return String.format("%s {s1=%.1f, s2=%.1f, s3=%.1f} perimeter = %.4f area = %.4f", this.getClass().getName(), getSide1(),
                getSide2(), getSide3(), perimeter(), calculateArea(triangle));
    }
}
